# PAIR Full-Stack Take-Home Exercise (max 2 hours): Learner Progress Slice
...
Our production stack is Vue 3 + TypeScript + Python/FastAPI/Postgres, but you do **not** need to use exactly that stack for the exercise.
...
- Missing row means no progress for that block
...
3. Clear instructions to run the API and frontend locally
